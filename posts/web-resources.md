---
title: "A list of useful resources for learning web dev"
...
If you're here to read interesting thoughts from me then you'll want to go check another post.

This one is just a list of links with a short description so I can give out this link to people who want some basic web development guides in the future.
...
That said Flexbox and Grid can be notably tricky so here's some links which focus on just those.

- [CSS Grid Garden](http://cssgridgarden.com/)
- [CSS Flexbox Froggy](https://flexboxfroggy.com/)
- [An Interactive Guide to CSS Grid by Josh W Comeau](https://www.joshwcomeau.com/css/interactive-guide-to-grid/#introduction) 
